...
//     const disabledStatesMap = cartItems.reduce((acc, cartItem) => {
//       acc[cartItem.imdbID] = true;
//       return acc;
//     }, {});
//     setDisabledStates(disabledStatesMap);
//   }, [cartItems]);
...
//               <Item>
//                 <img src={value.Images[0]} alt='blank' style={{ width: '170px' }} />
//                 <table>
//                   <tbody>
//                     <tr>
//                       <td>{value.Title ?? 'yash'}</td>
//                     </tr>
//                     <tr>
//                       <td>{value.Actors ?? 'yash'}</td>
//                     </tr>
//                     <tr>
